// decipher substituton without phrase.
...
int main ()
{
	...
	char subset[26] = "KEIJUTVHPSNCFAMWGD   YBROL";			// cipher table used to encrpyt worked out by looking at cipher text and substituting letters
	for (int i = 0; i <26; i++)
	{
	...
	cipher2 = fopen("subcipher2.txt", "r");
	...
	{
		printf("%dx%c's		%c \n", lettercounter[0][i],lettercounter[1][i],lettercounter[2][i]);
	}
